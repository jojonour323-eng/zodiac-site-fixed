...
// Emoji presentation of each sign glyph (with FE0F variation selector) —
// used next to sign names in titles, e.g. "Taurus ♉️".
export const SIGN_EMOJI: Record<SignId, string> = {
  aries: "\u2648\uFE0F",
  taurus: "\u2649\uFE0F",
  gemini: "\u264A\uFE0F",
  cancer: "\u264B\uFE0F",
