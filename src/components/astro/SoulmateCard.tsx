...
import { generateSoulmateReading } from "@/lib/astro/soulmateReading";
        ...
        <div className="p-5 sm:p-6">
          ...
          <div className="space-y-4">
            {personas.map((persona, i) => (
              <PersonaCard key={i} persona={persona} profile={profile} />
            ))}
          </div>
...
function PersonaCard({ persona, profile }: { persona: SoulmatePersona; profile: NatalProfile }) {
  ...
  // Generate the deep explanation connecting this persona to the user's actual chart.
  const reading = generateSoulmateReading(profile, persona);
  const deep = { headline: reading.headline, summary: reading.summary, sections: reading.sections };
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* Old short explanation — kept as a quick "why this works" line */}
        <div className="rounded-lg border border-white/10 bg-white/[0.02] p-3 mb-2">
        ...
        {/* Deep structured explanation — connects this persona to the user's actual chart */}
        <DeepExplanationView explanation={deep} expandLabel="Why this matches your chart" compact placementTags={reading.placementTags} />
      </div>
    </motion.div>
  );
}
